...
namespace Ollim.Infrastructure.Configurations
{
    public class OllimBot : IHostedService
    {
        ...
        public OllimBot(IServiceProvider serviceProvider, IConfiguration configuration)
        {
            ...
            {
                GatewayIntents = GatewayIntents.AllUnprivileged | GatewayIntents.GuildPresences | GatewayIntents.GuildVoiceStates | GatewayIntents.Guilds | GatewayIntents.GuildIntegrations
            };
